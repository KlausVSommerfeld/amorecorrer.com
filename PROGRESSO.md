...
- **A primeira feature pós-lançamento tem plano escrito e revisado, e não começou:** `PLANO-verificacao-radar-inmetro.md` especifica a verificação do medidor de velocidade no INMETRO/RBMLQ, escopo travado em RJ. Está bloqueada pela Fase 0.5 (calibração), que exige casos reais de multa que o produto ainda não tem. Ver pendência 18.
